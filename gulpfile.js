...
gulp.task('images', function () {
  return gulp.src(__dirname + '/client/images/**/*')
    .pipe(imagemin({
      optimizationLevel: 3,
      progressive: true,
      interlaced: true,
...
gulp.task('sass', function () {
  return gulp.src(__dirname + '/client/styles/**/*.scss')
    .pipe(rubySass())
...
gulp.task('dev', function () {
  ...
  gulp.watch(__dirname + '/client/images/**/*', ['images']);
  gulp.watch(__dirname + '/client/styles/**/*', ['styles']);
});
